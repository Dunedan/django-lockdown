...
urlpatterns = [
    ...
    re_path(
        r'^locked/view/with/exception1/', views.locked_view_with_exception),
    re_path(
        r'^locked/view/with/exception2/', views.locked_view_with_exception),
    ...
    re_path(
        r'^locked/view/until/yesterday/', views.locked_view_until_yesterday),
    re_path(
        r'^locked/view/until/tomorrow/', views.locked_view_until_tomorrow),
    re_path(
        r'^locked/view/after/yesterday/', views.locked_view_after_yesterday),
    re_path(
        r'^locked/view/after/tomorrow/', views.locked_view_after_tomorrow),
    re_path(
        r'^locked/view/until/and/after/', views.locked_view_until_and_after),
