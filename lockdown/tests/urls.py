...
urlpatterns = [
    ...
    url(r'^locked/view/with/ip_exception/',
        views.locked_view_with_ip_exception),
    url(r'^locked/view/with/ip_exception_ipv6/',
        views.locked_view_with_ip_exception_ipv6),
    url(r'^locked/view/with/ip_exception_subnet/',
        views.locked_view_with_ip_exception_subnet),
    url(r'^locked/view/with/ip_exception_ipv6_subnet/',
